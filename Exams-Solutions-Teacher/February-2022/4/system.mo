...
connect(s1.writesignal1, mreq2.writesignal1);
connect(s1.writesignal2, mreq2.writesignal2);
connect(s1.readsignal1, mreq2.readsignal1);
connect(s1.readsignal2, mreq2.readsignal2);
connect(s1.outputdata1, mreq2.outputdata1);
connect(s1.outputdata2, mreq2.outputdata2);
connect(s1.inputdata1, mreq2.inputdata1);
connect(s1.inputdata2, mreq2.inputdata2);
connect(s1.DB, mreq2.DB);


// MonitorReq3

connect(s1.writesignal1, mreq3.writesignal1);
connect(s1.writesignal2, mreq3.writesignal2);
connect(s1.readsignal1, mreq3.readsignal1);
connect(s1.readsignal2, mreq3.readsignal2);
connect(s1.outputdata1, mreq3.outputdata1);
connect(s1.outputdata2, mreq3.outputdata2);
connect(s1.inputdata1, mreq3.inputdata1);
connect(s1.inputdata2, mreq3.inputdata2);
connect(s1.DB, mreq3.DB);
